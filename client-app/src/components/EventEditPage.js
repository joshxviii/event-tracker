                ...
                <form onSubmit={handleSubmit} className="formGrid" aria-label="Create event form">
                    ...
                    <div className="twoCols">
                        <label className="labelStyle" style={{ flex: 1 }}>
                            ...
                            <input className="input" type="date" id="date" value={startDate} style={{color: 'var(--text-color)'}} onChange={(e) => {
                        ...
                        <label className="labelStyle" style={{ flex: 1 }}>
                            ...
                            <input className="input" type="date" id="date" value={endDate} style={{color: 'var(--text-color)'}} onChange={(e) => {
